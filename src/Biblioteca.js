...
var Usuario = /** @class */ (function () {
    function Usuario(nome, email, livrosEmprestados) {
        this.nome = nome;
        this.email = email;
...
var SistemaBiblioteca = /** @class */ (function () {
    ...
    SistemaBiblioteca.prototype.cadastrarLivro = function () {
        ...
        var anoPublicacao = leitor.questionInt("Em que ano ele foi publicado? ");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, executeDatabaseQuery("INSERT INTO livro(titulo, autor, anoPublicacao, quantidadeDisponivel) VALUES (?, ?, ?, ?)", [livro.titulo, livro.autor, livro.anoPublicacao, livro.quantidadeDisponivel])];
                    case 1:
                        _a.sent();
                        console.log('');
                        return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    console.error('Erro na execução da consulta', err_2);
                    throw err_2;
                case 3: return [2 /*return*/];
            }
        });
